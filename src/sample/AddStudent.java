...
public class AddStudent {
    ...
    public static void display(Stage window) {
        ...
        addStudentButton.setMinSize(150, 20);
        addStudentButton.setOnAction(e -> {

            if (fieldsCheck()) {
                Student.readStudentsFile();
                readNewStudent();
                Student.writeStudentsFile();
                AlertBox.display("Done", "Student added successfully!");
        ...
        layout.getChildren().addAll(addStudentLabel, informationLayout, addStudentButton);
    ...
    public static void readNewStudent() {
        ...
        Student.ids[Student.numberOfStudents] = idField.getText();
        Student.names[Student.numberOfStudents] = nameField.getText();
        Student.passwords[Student.numberOfStudents] = passwordField.getText();
        Student.emails[Student.numberOfStudents] = emailField.getText();
        Student.addresses[Student.numberOfStudents] = addressField.getText();
        Student.cities[Student.numberOfStudents] = cityField.getText();
        Student.contacts[Student.numberOfStudents] = contactNumberField.getText();
    ...
    private static boolean fieldsCheck() {
        ...
        for (int i = 0; i < Student.numberOfStudents; i++) {
            if (idField.getText().equals(Student.ids[i])){
        ...
        for (int i = 0; i < Student.numberOfStudents; i++) {
            if (nameField.getText().equals(Student.names[i])){
        ...
        for (int i = 0; i < Student.numberOfStudents; i++) {
            if (emailField.getText().equals(Student.emails[i])){
